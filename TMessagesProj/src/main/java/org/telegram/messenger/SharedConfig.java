...
public class SharedConfig {
    ...
    // CRYPTOGRAM OPSEC Settings
    public static boolean cryptogramPanicPasswordEnabled = false;
    public static boolean cryptogramAntiForensicsEnabled = false;
    public static boolean cryptogramDeadManSwitchEnabled = false;
    public static boolean cryptogramTrafficObfuscationEnabled = false;
    public static boolean cryptogramDpiEvasionEnabled = false;
    public static int cryptogramDpiEvasionMethod = 0; // 0=HTTPS,1=HTTP,2=DNS,3=Generic,4=Auto
    public static int cryptogramQuantumSecurityLevel = 128; // 128,256,384
    public static int cryptogramThreatDefenseLevel = 0; // 0=Standard,1=Enhanced,2=Maximum
    public static boolean cryptogramStylometryShieldEnabled = false;
    public static int cryptogramStylometryMode = 0; // 0=Rules,1=Model
    public static int cryptogramStylometryStrength = 1; // 0=Light,1=Medium,2=Heavy
    public static boolean cryptogramUtdEnabled = false;
    public static int cryptogramUtdThreshold = 50; // 0-100
    public static boolean cryptogramVoiceMorphingEnabled = false;
    public static boolean cryptogramLocationPrivacyEnabled = false;
    public static boolean cryptogramInterfaceCamouflageEnabled = false;
    public static boolean cryptogramMediaMetadataSpoofingEnabled = false;
    public static boolean cryptogramTrafficPaddingEnabled = false;
    public static boolean cryptogramHardwareTetherEnabled = false;
    public static boolean cryptogramImapProtectionEnabled = false;
    public static int cryptogramImapProtectionLevel = 0; // 0=None,2=Standard,4=Maximum
...
//    public static int saveToGalleryFlags;
    ...
    public static void loadConfig() {
        synchronized (sync) {
            ...
            // CRYPTOGRAM OPSEC Settings
            cryptogramPanicPasswordEnabled = preferences.getBoolean("cryptogramPanicPassword", false);
            cryptogramAntiForensicsEnabled = preferences.getBoolean("cryptogramAntiForensics", false);
            cryptogramDeadManSwitchEnabled = preferences.getBoolean("cryptogramDeadManSwitch", false);
            cryptogramTrafficObfuscationEnabled = preferences.getBoolean("cryptogramTrafficObfuscation", false);
            cryptogramDpiEvasionEnabled = preferences.getBoolean("cryptogramDpiEvasion", false);
            cryptogramDpiEvasionMethod = preferences.getInt("cryptogramDpiEvasionMethod", 0);
            cryptogramQuantumSecurityLevel = preferences.getInt("cryptogramQuantumSecurityLevel", 128);
            cryptogramThreatDefenseLevel = preferences.getInt("cryptogramThreatDefenseLevel", 0);
            cryptogramStylometryShieldEnabled = preferences.getBoolean("cryptogramStylometryShield", false);
            cryptogramStylometryMode = preferences.getInt("cryptogramStylometryMode", 0);
            cryptogramStylometryStrength = preferences.getInt("cryptogramStylometryStrength", 1);
            cryptogramUtdEnabled = preferences.getBoolean("cryptogramUtd", false);
            cryptogramUtdThreshold = preferences.getInt("cryptogramUtdThreshold", 50);
            cryptogramVoiceMorphingEnabled = preferences.getBoolean("cryptogramVoiceMorphing", false);
            cryptogramLocationPrivacyEnabled = preferences.getBoolean("cryptogramLocationPrivacy", false);
            cryptogramInterfaceCamouflageEnabled = preferences.getBoolean("cryptogramInterfaceCamouflage", false);
            cryptogramMediaMetadataSpoofingEnabled = preferences.getBoolean("cryptogramMediaMetadataSpoofing", false);
            cryptogramTrafficPaddingEnabled = preferences.getBoolean("cryptogramTrafficPadding", false);
            cryptogramHardwareTetherEnabled = preferences.getBoolean("cryptogramHardwareTether", false);
            cryptogramImapProtectionEnabled = preferences.getBoolean("cryptogramImapProtection", false);
            cryptogramImapProtectionLevel = preferences.getInt("cryptogramImapProtectionLevel", 0);
    ...
    // CRYPTOGRAM OPSEC toggle methods
    public static void toggleCryptogramPanicPassword() {
        cryptogramPanicPasswordEnabled = !cryptogramPanicPasswordEnabled;
        SharedPreferences preferences = MessagesController.getGlobalMainSettings();
        SharedPreferences.Editor editor = preferences.edit();
        editor.putBoolean("cryptogramPanicPassword", cryptogramPanicPasswordEnabled);
        editor.apply();
    }

    public static void toggleCryptogramAntiForensics() {
        cryptogramAntiForensicsEnabled = !cryptogramAntiForensicsEnabled;
        SharedPreferences preferences = MessagesController.getGlobalMainSettings();
        SharedPreferences.Editor editor = preferences.edit();
        editor.putBoolean("cryptogramAntiForensics", cryptogramAntiForensicsEnabled);
        editor.apply();
    }

    public static void toggleCryptogramDeadManSwitch() {
        cryptogramDeadManSwitchEnabled = !cryptogramDeadManSwitchEnabled;
        SharedPreferences preferences = MessagesController.getGlobalMainSettings();
        SharedPreferences.Editor editor = preferences.edit();
        editor.putBoolean("cryptogramDeadManSwitch", cryptogramDeadManSwitchEnabled);
        editor.apply();
    }

    public static void toggleCryptogramTrafficObfuscation() {
        cryptogramTrafficObfuscationEnabled = !cryptogramTrafficObfuscationEnabled;
        SharedPreferences preferences = MessagesController.getGlobalMainSettings();
        SharedPreferences.Editor editor = preferences.edit();
        editor.putBoolean("cryptogramTrafficObfuscation", cryptogramTrafficObfuscationEnabled);
        editor.apply();
    }

    public static void toggleCryptogramDpiEvasion() {
        cryptogramDpiEvasionEnabled = !cryptogramDpiEvasionEnabled;
        SharedPreferences preferences = MessagesController.getGlobalMainSettings();
        SharedPreferences.Editor editor = preferences.edit();
        editor.putBoolean("cryptogramDpiEvasion", cryptogramDpiEvasionEnabled);
        editor.apply();
    }

    public static void setCryptogramDpiEvasionMethod(int value) {
        cryptogramDpiEvasionMethod = Math.max(0, Math.min(value, 4));
        SharedPreferences preferences = MessagesController.getGlobalMainSettings();
        SharedPreferences.Editor editor = preferences.edit();
        editor.putInt("cryptogramDpiEvasionMethod", cryptogramDpiEvasionMethod);
        editor.apply();
    }

    public static void setCryptogramQuantumSecurityLevel(int value) {
        cryptogramQuantumSecurityLevel = value;
        SharedPreferences preferences = MessagesController.getGlobalMainSettings();
        SharedPreferences.Editor editor = preferences.edit();
    ...
    public static void setCryptogramThreatDefenseLevel(int value) {
        cryptogramThreatDefenseLevel = Math.max(0, Math.min(value, 2));
        SharedPreferences preferences = MessagesController.getGlobalMainSettings();
        SharedPreferences.Editor editor = preferences.edit();
    ...
    public static void toggleCryptogramStylometryShield() {
        cryptogramStylometryShieldEnabled = !cryptogramStylometryShieldEnabled;
        SharedPreferences preferences = MessagesController.getGlobalMainSettings();
        SharedPreferences.Editor editor = preferences.edit();
        editor.putBoolean("cryptogramStylometryShield", cryptogramStylometryShieldEnabled);
        editor.apply();
    }

    public static void setCryptogramStylometryMode(int value) {
        cryptogramStylometryMode = Math.max(0, Math.min(value, 1));
        SharedPreferences preferences = MessagesController.getGlobalMainSettings();
        SharedPreferences.Editor editor = preferences.edit();
        editor.putInt("cryptogramStylometryMode", cryptogramStylometryMode);
        editor.apply();
    }

    public static void setCryptogramStylometryStrength(int value) {
        cryptogramStylometryStrength = Math.max(0, Math.min(value, 2));
        SharedPreferences preferences = MessagesController.getGlobalMainSettings();
        SharedPreferences.Editor editor = preferences.edit();
        editor.putInt("cryptogramStylometryStrength", cryptogramStylometryStrength);
        editor.apply();
    }

    public static void toggleCryptogramUtd() {
        cryptogramUtdEnabled = !cryptogramUtdEnabled;
        SharedPreferences preferences = MessagesController.getGlobalMainSettings();
        SharedPreferences.Editor editor = preferences.edit();
        editor.putBoolean("cryptogramUtd", cryptogramUtdEnabled);
        editor.apply();
    }

    public static void setCryptogramUtdThreshold(int value) {
        cryptogramUtdThreshold = Math.max(0, Math.min(value, 100));
        SharedPreferences preferences = MessagesController.getGlobalMainSettings();
        SharedPreferences.Editor editor = preferences.edit();
        editor.putInt("cryptogramUtdThreshold", cryptogramUtdThreshold);
        editor.apply();
    }

    public static void toggleCryptogramVoiceMorphing() {
        cryptogramVoiceMorphingEnabled = !cryptogramVoiceMorphingEnabled;
        SharedPreferences preferences = MessagesController.getGlobalMainSettings();
        SharedPreferences.Editor editor = preferences.edit();
        editor.putBoolean("cryptogramVoiceMorphing", cryptogramVoiceMorphingEnabled);
        editor.apply();
    }

    public static void toggleCryptogramLocationPrivacy() {
        cryptogramLocationPrivacyEnabled = !cryptogramLocationPrivacyEnabled;
        SharedPreferences preferences = MessagesController.getGlobalMainSettings();
        SharedPreferences.Editor editor = preferences.edit();
        editor.putBoolean("cryptogramLocationPrivacy", cryptogramLocationPrivacyEnabled);
        editor.apply();
    }

    public static void toggleCryptogramInterfaceCamouflage() {
        cryptogramInterfaceCamouflageEnabled = !cryptogramInterfaceCamouflageEnabled;
        SharedPreferences preferences = MessagesController.getGlobalMainSettings();
        SharedPreferences.Editor editor = preferences.edit();
        editor.putBoolean("cryptogramInterfaceCamouflage", cryptogramInterfaceCamouflageEnabled);
        editor.apply();
    }

    public static void toggleCryptogramMediaMetadataSpoofing() {
        cryptogramMediaMetadataSpoofingEnabled = !cryptogramMediaMetadataSpoofingEnabled;
        SharedPreferences preferences = MessagesController.getGlobalMainSettings();
        SharedPreferences.Editor editor = preferences.edit();
        editor.putBoolean("cryptogramMediaMetadataSpoofing", cryptogramMediaMetadataSpoofingEnabled);
        editor.apply();
    }

    public static void toggleCryptogramTrafficPadding() {
        cryptogramTrafficPaddingEnabled = !cryptogramTrafficPaddingEnabled;
        SharedPreferences preferences = MessagesController.getGlobalMainSettings();
        SharedPreferences.Editor editor = preferences.edit();
        editor.putBoolean("cryptogramTrafficPadding", cryptogramTrafficPaddingEnabled);
        editor.apply();
    }

    public static void toggleCryptogramHardwareTether() {
        cryptogramHardwareTetherEnabled = !cryptogramHardwareTetherEnabled;
        SharedPreferences preferences = MessagesController.getGlobalMainSettings();
        SharedPreferences.Editor editor = preferences.edit();
        editor.putBoolean("cryptogramHardwareTether", cryptogramHardwareTetherEnabled);
        editor.apply();
    }

    public static void toggleCryptogramImapProtection() {
        cryptogramImapProtectionEnabled = !cryptogramImapProtectionEnabled;
        SharedPreferences preferences = MessagesController.getGlobalMainSettings();
        SharedPreferences.Editor editor = preferences.edit();
        editor.putBoolean("cryptogramImapProtection", cryptogramImapProtectionEnabled);
        editor.apply();
    }

    public static void setCryptogramImapProtectionLevel(int value) {
        cryptogramImapProtectionLevel = value;
        SharedPreferences preferences = MessagesController.getGlobalMainSettings();
        SharedPreferences.Editor editor = preferences.edit();
        editor.putInt("cryptogramImapProtectionLevel", cryptogramImapProtectionLevel);
        editor.apply();
    }
