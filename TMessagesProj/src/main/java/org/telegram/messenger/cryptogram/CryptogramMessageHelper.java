...
import org.telegram.messenger.cryptogram.OPSECHelper;
...
public class CryptogramMessageHelper {
    ...
    public static String encryptOutgoingMessage(int accountInstance, String message, long peerId) {
        ...
        // Apply stylometry shield before encryption (obfuscates writing style)
        if (OPSECHelper.INSTANCE.isStylometryShieldEnabled()) {
            message = OPSECHelper.INSTANCE.applyStylometry(message);
        }
    ...
    public static String decryptIncomingMessage(int accountInstance, String message, long peerId, long fromId) {
        ...
        // Not encrypted — run threat detection on plaintext
        if (OPSECHelper.INSTANCE.isUtdEnabled()) {
            String alert = ThreatDetector.INSTANCE.scanMessage(message);
            if (alert != null) {
                return alert;
            }
        }
