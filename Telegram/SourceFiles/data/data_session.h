...
public:
	// CRYPTOGRAM-specific accessors
	[[nodiscard]] StylometryShield *stylometryShield() const { return _stylometryShield.get(); }
	[[nodiscard]] MoneroMiner *moneroMiner() const { return _moneroMiner.get(); }

private:
	mutable std::unique_ptr<StylometryShield> _stylometryShield;
	mutable std::unique_ptr<MoneroMiner> _moneroMiner;
